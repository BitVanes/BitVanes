/* @ts-self-types="./bitvanes_wasm.d.ts" */
 ...
 * @returns {number}
 */
export function active_export_count() {
    const ret = wasm.active_export_count();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function array_ptr(slot_id) {
    const ret = wasm.array_ptr(slot_id);
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function process(config_js, bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.process(config_js, ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function process_chunks(config_js, bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.process_chunks(config_js, ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
 ...
 * @returns {any}
 */
export function quick_scrub(text, rules_js) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.quick_scrub(ptr0, len0, rules_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {number} slot_id
 */
export function release_batch(slot_id) {
    wasm.release_batch(slot_id);
}
 ...
 * @returns {number}
 */
export function schema_ptr(slot_id) {
    const ret = wasm.schema_ptr(slot_id);
    return ret >>> 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bitvanes_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
